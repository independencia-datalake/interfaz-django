    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marca_producto', models.CharField(max_length=200, null=True, verbose_name='Nombre del Producto')),
                ('p_a', models.CharField(max_length=200, null=True, verbose_name='Componente Activo')),
                ('dosis', models.CharField(max_length=200, null=True, verbose_name='Dosis del Producto')),
                ('presentacion', models.CharField(max_length=200, null=True, verbose_name='Presentacion del Producto')),
                ...
                ('n_lote', models.CharField(max_length=200, null=True, verbose_name='Lote')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Fecha de edición')),
