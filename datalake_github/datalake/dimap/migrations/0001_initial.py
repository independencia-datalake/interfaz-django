    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, max_length=200, null=True, verbose_name='Nombre Denunciado')),
                ('apellido', models.CharField(blank=True, max_length=200, null=True, verbose_name='Apellido Denunciado')),
                ('calle', models.CharField(blank=True, max_length=200, null=True, verbose_name='Calle Denunciado')),
                ('numero', models.PositiveIntegerField(blank=True, null=True, verbose_name='Numeración')),
                ('telefono', models.CharField(blank=True, max_length=200, null=True, verbose_name='Teléfono Denunciado')),
