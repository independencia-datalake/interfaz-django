    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apellido', models.CharField(blank=True, max_length=30, null=True, verbose_name='Apelledio Denunciado')),
                ...
                ('telefono', models.CharField(blank=True, max_length=30, null=True, verbose_name='Telefono Denunciado')),
                ('f_visita', models.DateField(verbose_name='Fecha de visita inspeccion')),
                ('l_transgrsion', models.CharField(choices=[('1', 'Via Pública'), ('2', 'Domicilio')], max_length=1, verbose_name='Lugar de Transgresión')),
                ('i_visita', models.CharField(choices=[('1', 'Inspector'), ('2', 'Profecional')], max_length=1, verbose_name='Visita Inspectiva')),
                ...
                ('notificacion', models.CharField(blank=True, choices=[('1', 'Con Notificacion'), ('2', 'Sin Notificacion')], default='', max_length=1, verbose_name='Notificacion')),
                ('n_notificacion', models.PositiveIntegerField(blank=True, null=True, verbose_name='Numero de Notificacion')),
