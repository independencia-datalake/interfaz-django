    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_correo', models.CharField(choices=[('PERSONAL', 'Personal'), ('TRABAJO', 'Trabajo'), ('ESCUELA', 'Escuela'), ('OTRO', 'Otro')], default='PERSONAL', max_length=200, null=True, verbose_name='Tipo de Correo')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Fecha de edición')),
                ('persona', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.persona', verbose_name='Persona')),
            ],
