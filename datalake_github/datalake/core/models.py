...
class Persona(models.Model):
    ...
    numero_identificacion = models.CharField(max_length=30, blank=True, verbose_name="Numero de Identidad", unique=True)
    ...
    direccion_persona = models.CharField(max_length=30, verbose_name="Nombre de calle")
    numero_direccion = models.PositiveIntegerField(verbose_name="Numero de direccion")
    complemento_direccion = models.CharField(max_length=50, verbose_name='Complemento de Dirección')
    telefono_persona = models.CharField(max_length=30, verbose_name="Telefono Persona")
    correo_persona = models.EmailField(max_length=40, verbose_name="Email Persona")
