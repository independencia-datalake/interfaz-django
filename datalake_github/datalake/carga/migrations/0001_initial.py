    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_documento', models.CharField(choices=[('RUT', 'Rut'), ('PASAPORTE', 'Pasaporte'), ('OTRO', 'Otro')], default='RUT', max_length=200, verbose_name='Tipo de Documento')),
                ...
                ('estado_civil', models.CharField(blank=True, max_length=200, null=True, verbose_name='Estado Civil')),
                ('ocupacion', models.CharField(blank=True, max_length=200, null=True, verbose_name='Ocupación')),
                ...
                ('adj_docu', models.URLField(blank=True, null=True, verbose_name='Adjuntar Documentos')),
